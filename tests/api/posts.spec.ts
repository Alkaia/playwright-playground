...
test.describe('Posts API CRUD Tests', () => {
  ...
  test('should update an existing post', async () => {
    ...
    const response = await request.put(`${apiClient.getBaseUrl()}/posts/${apiTestData.posts.validPostId}`, {
      data: updatedData,
    });
  ...
  test('should retrieve a specific post', async () => {
    const response = await apiClient.getResponse(`/posts/${apiTestData.posts.validPostId}`);
  ...
  test('should delete a post', async () => {
    const response = await request.delete(`${apiClient.getBaseUrl()}/posts/${apiTestData.posts.validPostId}`);
