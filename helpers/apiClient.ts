...
export class ApiClient {
   ...
   */
  async post<T>(endpoint: string, body: Record<string, JsonValue> | JsonValue[], options?: { headers?: Record<string, string> }): Promise<T> {
   ...
   */
  async put<T>(endpoint: string, body: Record<string, JsonValue> | JsonValue[]): Promise<T> {
   ...
   */
  async getResponse(endpoint: string, options?: { headers?: Record<string, string> }): Promise<Awaited<ReturnType<APIRequestContext['get']>>> {
